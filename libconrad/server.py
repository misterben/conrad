...
from libconrad import autoreload, core

logger = logging.getLogger(__name__)


class libconradHTTPRequestHandler(SimpleHTTPRequestHandler):
...
def run_server(address, port, source, dest):
    ...
    libconradHTTPRequestHandler.rootpath = dest
    httpd = HTTPServer((address, port), libconradHTTPRequestHandler)
